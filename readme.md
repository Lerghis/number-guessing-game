...
A console-based interactive [number-guessing-game](https://roadmap.sh/projects/number-guessing-game) built in Java. This project demonstrates real application program structure, clean input handling, and exception management.
